    ...
    <div class="flex-1 space-y-5 overflow-y-auto px-4 py-4">
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <label for="reader-font-size" class="text-xs font-medium text-muted-foreground"
            >Font Size</label
          >
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <label for="reader-line-height" class="text-xs font-medium text-muted-foreground"
            >Line Height</label
          >
      ...
      <div class="space-y-2">
        ...
        <div class="flex gap-3">
          {#each themeOptions as t (t.value)}
            ...
            >
              <span
                class="inline-flex size-8 items-center justify-center rounded-full {prefs.theme ===
                t.value
              ...
              ></span>
              <span
                class="text-xs {prefs.theme === t.value
                  ? 'font-medium text-foreground'
                  : 'text-muted-foreground'}">{t.label}</span
              >
            </button>
          {/each}
        </div>
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <label for="reader-margins" class="text-xs font-medium text-muted-foreground"
            >Margins</label
          >
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <label for="reader-max-width" class="text-xs font-medium text-muted-foreground"
            >Max Width</label
          >
