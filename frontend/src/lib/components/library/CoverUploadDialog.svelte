...
<Dialog.Root {open} onOpenChange={handleOpenChange}>
  <Dialog.Content>
    <Dialog.Header>
      ...
      <Dialog.Description>
        The cover image will be updated immediately. This is separate from any pending form edits.
      </Dialog.Description>
    </Dialog.Header>
    <div
    ...
    >
      ...
      <p class="text-sm text-muted-foreground">Drag and drop an image here, or</p>
