...
describe('BookEditForm', () => {
	...
	beforeEach(() => {
		...
		book = createBookDetail({
			...
			authors: [
				createAuthorEntry({ id: 'a1', name: 'Author One', sort_name: 'One, Author', role: 'author', position: 0 }),
				createAuthorEntry({ id: 'a2', name: 'Author Two', sort_name: 'Two, Author', role: 'author', position: 1 })
			],
