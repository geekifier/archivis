  ...
  <div class="flex items-start justify-between gap-4">
    ...
    <div class="min-w-0 flex-1">
      <div class="flex items-center gap-2">
        <!-- Status dot -->
        <span class="inline-block size-2.5 shrink-0 rounded-full {statusColor}" title={statusLabel}
        ></span>
      ...
      {#if directory.last_error}
        <div class="mt-2">
          ...
          >
            <svg
              class="size-3.5 shrink-0 transition-transform {errorExpanded ? 'rotate-90' : ''}"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              stroke-width="2"
        ...
        <AlertDialog.Content>
          <AlertDialog.Header>
            ...
            <AlertDialog.Description>
              This will stop watching this directory. Already imported books will not be affected.
            </AlertDialog.Description>
          </AlertDialog.Header>
          <AlertDialog.Footer>
