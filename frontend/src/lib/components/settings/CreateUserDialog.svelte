...
<Dialog.Root {open} onOpenChange={handleOpenChange}>
  <Dialog.Content class="sm:max-w-md">
    ...
    <div class="space-y-4">
      <div>
        <Label for="create-username" class="mb-1.5 block text-sm font-medium">Username</Label>
        <Input
          id="create-username"
          type="text"
      ...
      <div>
        <Label for="create-password" class="mb-1.5 block text-sm font-medium">Password</Label>
        <Input
          id="create-password"
          type="password"
