          ...
          <div class="p-4">
            ...
            <div class="mb-3 flex items-center justify-between">
              <div class="flex items-center gap-3">
                <span
                  class="inline-flex rounded-full px-2 py-0.5 text-xs font-medium {detectionMethodClass(
              ...
              <div class="flex items-center gap-2">
                ...
                <Button size="sm" class="h-7 px-2 text-xs" onclick={() => openMergeDialog(link)}>
                  Review
                </Button>
              </div>
            </div>
              ...
              >
                ...
                >
                  ...
                  {:else}
                    ...
                    >
                      <span class="line-clamp-3 text-center text-[8px] font-medium text-white/80">
                        {link.book_a.title}
                      </span>
                    </div>
                  {/if}
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-1 text-sm text-muted-foreground">
          Your library has no pending duplicate pairs to review. Duplicates are detected
          automatically during import or can be flagged manually from book detail pages.
        </p>
      </div>
    </div>
  {/if}
