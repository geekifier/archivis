...
pub struct ReconciliationInput {
    ...
    pub publication_date: EnrichmentFieldInput,
...
impl std::fmt::Display for PlannedField {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::PublicationDate => write!(f, "publication_date"),
...
fn field_display_label(field: PlannedField) -> &'static str {
    match field {
        ...
        PlannedField::PublicationDate => "Publication date",
...
pub fn plan_reconciliation(input: &ReconciliationInput) -> ReconciliationPlan {
    ...
    for (field, data) in [
        ...
        (PlannedField::PublicationDate, input.publication_date),
